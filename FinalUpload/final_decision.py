...
sData_train = pd.read_csv('data/training_data.csv', encoding='utf-8')
sData_test = pd.read_csv('data/test_data.csv', encoding='utf-8')
...
for k in range(1):
    ...
    result = decision.getResult(mynode,data_test, ma, 'bot',testindexlist )
    headers = ['id','bot']
    rows=[];
